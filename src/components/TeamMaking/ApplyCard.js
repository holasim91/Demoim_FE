          ...
          <React.Fragment>
            <MobileUserInfoBox>
              <Image
                size="45"
                src={
                  props.responseUser.profileImage
                    ? props.responseUser.profileImage
                    : DefaultProfile
                }
              />
              ...
              <UserInfo>
                <InfoText className="user">
                  ...
                  <Position>{props.responseUser?.position}</Position>
                </InfoText>
            ...
            <MobileMsgBox>
              <MsgMentBox>
                <InfoText className="apply">메세지</InfoText>
                <MsgBox>{props.message}</MsgBox>
              </MsgMentBox>
              <MsgMentBox>
                <InfoText className="apply">포트폴리오</InfoText>
                <MsgBox>{props.portfolio}</MsgBox>
              </MsgMentBox>
              <MobileBtnBox>
          ...
          <React.Fragment>
            ...
            <InfoBox>
              ...
              <UserInfoBpx>
                <InfoText className="desc intro">
                  {props.responseUser?.description.length > 75
                    ? props.responseUser?.description.slice(0, 75) + "..."
                    : props.responseUser?.description}
                </InfoText>
              </UserInfoBpx>
            </InfoBox>
            <InfoBox className="msg">
              <ApplyBox>
                ...
                <MsgMentBox>
                  <InfoText className="apply">포트폴리오</InfoText>
                  <MsgBox className="portfolio">{props.portfolio}</MsgBox>
                </MsgMentBox>
              </ApplyBox>
              <BtnBox>
