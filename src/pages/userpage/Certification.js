...
import { Grid, Container,CheckBox } from "../../elements";
    ...
    <React.Fragment>
      ...
      <PageTitleContainer>
        ...
        <StepBox>
          ...
          <StepLine>---------</StepLine>
          <Step bg="#d8d8d8" color="#000000">2단계</Step>
        </StepBox>
      </PageTitleContainer>
        ...
        <CertificateForm>
          ...
          <CheckBoxTable>
            ...
            <tr>
              ...
              <tr>
                <td>
                  <Checkbox type="checkbox"label="" checked={check.check} 
                  onChange={(e) => handleCheck(e, "check")}/>
                  </td>
                <td>개인정보 처리 방침에 대한 이용약관에 동의</td>
                <td><CheckContents onClick={() => {
                  //history.push('/privacy')
                }}> {">"} 전문보기</CheckContents></td>
              </tr>
            </tbody>
          </CheckBoxTable>
          {/* <h2>{check.check? "ok" : "fa"}</h2> */}
