  ...
  return (
    <>
      <Container>
        ...
        <Announce>
          <p>
            {"<"}데모임{">"}('http://www.demoim.co.kr'이하 'Demoim') 은(는)
            「개인정보 보호법」 제30조에 따라 정부주체의 개인정보를 보호하고
            이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여
            다음과 같이 개인정보 처리방침을 수립·공개합니다.
          </p>
          <p>이 개인정보처리방침은 2021년 5월 19부터 적용됩니다.</p>
        </Announce>
        <Chapter>
          <p className="chapter-title">제1조(개인정보의 처리 목적)</p>
          <p className="content">
            {"<"}데모임{">"}('http://www.demoim.co.kr'이하 'Demoim') 은(는)
            다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는
            다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는
            겨우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등
            필요한 조치를 이행할 예정입니다.
          </p>
          <ul className="detail">
            <li>
            ...
            <li>
              <p>4. 마케팅 및 광고에의 활용리</p>
              <p>
                신규 서비스(제품) 개발 및 맞춤 서비스 제공, 서비스의 유효성
        ...
        <Chapter>
          <p className="chapter-title">제2조(개인정보의 처리 및 보유 기간)</p>
          <p>
            ① {"<"}데모임{">"} 은(는) 법령에 따른 개인정보 보유·이용기간 또는
          ...
          <ul>
            ...
            <li>보유근거 : 서비스를 위한 회원정보 유지 및 관리</li>
            <li>
        ...
        <Chapter>
          ...
          <p>
            ① 정보주체는 데모임에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
            요구 등의 권리를 행사할 수 있습니다.
          </p>
          <p>
            ② 제1항에 따른 권리 행사는데모임에 대해 「개인정보 보호법」 시행령
            제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
            있으며 데모임은(는) 이에 대해 지체 없이 조치하겠습니다.{" "}
          </p>
          <p>
          ...
          <p>
            ⑥ 데모임은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
            처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
            대리인인지를 확인합니다.
          </p>
        </Chapter>
        <Chapter>
          <p className="chapter-title">제4조(처리하는 개인정보의 항목 작성)</p>
          <p>
            ① {"<"}데모임{">"} 은(는) 다음의 개인정보 항목을 처리하고 있습니다
          </p>
          <ul>
            <li>
              {"<"} 홈페이지 회원가입 및 관리 {">"}
            ...
            <li>
              필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 이름, 서비스
              이용 기록, 접속 로그, 쿠키, 접속 IP 정보
            </li>
          </ul>
        </Chapter>
        <Chapter>
          <p className="chapter-title">제5조(개인정보의 파기)</p>
          <p>
            ① {"<"}데모임{">"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
          ...
          <p>1. 파기절차</p>
          <p>
            {"<"}데모임{">"} 은(는) 파기 사유가 발생한 개인정보를 선정하고,{" "}
            {"<"}데모임{">"} 의 개인정보 보호책임자의 승인을 받아 개인정보를
            파기합니다.
          </p>
          <p>2. 파기방법</p>
          <p>
        ...
        <Chapter>
          <p className="chapter-title">제6조(개인정보의 안전성 확보 조치)</p>
          <p className="content">
            {"<"}데모임{">"} 은(는) 개인정보의 안전성 확보를 위해 다음과 같은
            조치를 취하고 있습니다.
          </p>
          <ul>
            <li>
        ...
        <Chapter>
          ...
          <p>
            ① 데모임 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
            ...
            거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스
            이용에 어려움이 발생할 수 있습니다.
          </p>
        </Chapter>
        <Chapter>
          <p className="chapter-title">제8조 (개인정보 보호책임자)</p>
          <p>
            ① 데모임 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
          ...
          <ul>
            <li>▶ 개인정보 보호책임자</li>
            <li>성명 : 정석진</li>
            <li>이메일 : strong1133@naver.com</li>
          </ul>
          <p>※ 개인정보 보호 담당부서로 연결됩니다.</p>
          <ul>
            <li>▶ 개인정보 보호 담당자</li>
            <li>성명 : 김준엽</li>
            <li>이메일 : ckjy1105@naver.com</li>
          </ul>
          <p>
            ② 정보주체께서는 데모임 의 서비스(또는 사업)을 이용하시면서 발생한
            모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
            개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 데모임
            은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
          </p>
        </Chapter>
        <Chapter>
          <p className="chapter-title">제9조(개인정보 열람청구)</p>
          <p className="content">
            정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를
            아래의 부서에 할 수 있습니다.
            {"<"}데모임{">"}은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.
          </p>
          <ul>
            <li>▶ 개인정보 열람청구 접수·처리자</li>
            <li>성명 : 이은지</li>
            <li>이메일 : dmsql5303@naver.com</li>
          </ul>
        </Chapter>
        <Chapter>
          <p className="chapter-title">제10조(권익침해 구제방법)</p>
          <p>
